...
if($errorCount > 0){
    ...
    for($counter = 0; $counter < $countAllUsers ; $counter++){
        ...
        if($currentUser == $email . ".json"){
            ...
            $message = "A password reset has been requested from your account, if you did not submit this request, please ignore this message, otherwise, visit: localhost/snh/reset.php?token=".$token;
