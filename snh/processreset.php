         ...
         if($checkToken){
            ...
            for($counter = 0; $counter < $countAllUsers; $counter++){
                ...
                file_put_contents("db/users/". $email . ".json", json_encode($userObject)); 
                  ...
                  $message = "Your account on shn has just been updated, your password has changed, if you did not the password change, please visit snh.org and reset your password immediately";
